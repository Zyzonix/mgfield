...
mysqlTableTemplates = {
    "mgfield" : "`mgfield`(`time_utc`, `time_local`, `x_value`, `y_value`, `z_value`, `out_value`, `measurement_duration`, `start_avg`) ",
    ...
    "sysstats" : "`sysstats`(`time_utc`, `time_local`, `cpu_speed`, `cpu_usage`, `cpu_ctx_switches`, `cpu_interrupts`, `cpu_soft_interrupts`, `ram_total`, `ram_free`, `ram_used`, `ram_cached`, `ram_free_wcache_perc`, `ram_free_wocache_perc`, `cpu_thermal`, `uptime`) ",
